    ...
    return (
        <div>
            ...
            <div className="col-12">
                    ...
                    <div className="row" style={{justifyContent:"center",margin:10,alignItems:"center"}} >
            ...
            <div className="row" style={{justifyContent: "center",fontWeight:"bold"}}>Gestpark © 2021</div>
        </div>
    )
}
