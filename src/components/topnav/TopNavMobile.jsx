...
const LogoutModal = ({handleLogout,show,close})=>(
        <Modal backdrop="static" show={show} onHide={close} style={{width:"100%"}}>
            <Modal.Body>
            
            <div className="row" style={{width:"90%",margin:0,justifyContent:"center"}}><Icon
                icon="remind"
                style={{
                color: '#ffb300',
                fontSize: 30
            ...
            /></div>
            <div className="row" style={{width:"90%",margin:0,textAlign:"center"}}>Voulez-vous vraiment vous déconnecter ?</div>
...
const ExportModal = ({isSelected,show,close,confirme,dateChange,yearChange,season,listVilles,handleVilleChange,handleVilleUpdate}) =>(
    ...
    <Modal style={{width:"100%"}}   backdrop="static"  show={show} onHide={close}>
        <Modal.Header>
            <Modal.Title>
        ...
        <div className='topnav-mobile'>
                ...
                <div className="row" style={{width:"100%",margin:0,justifyContent:"center"}}>
                    <div style={{
                        ...
                        <img style={{ 
                            height:"50px",
                            backgroundSize: "contain",}} src={smallLogo} alt="small" />
                        <img style={{ 
                            height:"80px",
                            backgroundSize: "contain",}} src={logo} alt="gestpark" />
                    </div>
                    <div className="row" style={{width:"100%",margin:0,justifyContent:"space-between"}}>
