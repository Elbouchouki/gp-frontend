...
const Routes = () => {
    ...
    return (
        <Switch>
            ...
            <ProtectedRoute perm="show_recu_normal" path='/tickets' exact component={()=><Recu type="normal" articleId={[1,2,3,9]} pageTitle="Tickets"/>}/>
            <ProtectedRoute perm="show_recu_normal" path='/traffic' exact component={()=><Traffic articleId={[1,2,3,9]} pageTitle="Traffic"/>}/>
            ...
            <ProtectedRoute perm="show_bilan" path='/bilans' exact component={()=><Bilan pageTitle="Bilans"/>}/>
            ...
            <ProtectedRoute perm="show_users" path='/utilisateurs' exact component={()=><Users pageTitle="Utilisateurs"/>}/>
